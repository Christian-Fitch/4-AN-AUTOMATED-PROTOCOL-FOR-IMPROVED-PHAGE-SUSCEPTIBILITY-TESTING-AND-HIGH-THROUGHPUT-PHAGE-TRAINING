...
def run(ctx):
    ...
    volume_to_spot = 2.5 # Default = 4 (ul)
    ...
    num_dilutions_per_sample = 0 # Use either 3, 4, 6 or 12 dilutions per sample to fit on a row without remainder
    num_samples_used = 0 # For example; maximum = 16 when 6 dilutions per sample used
    # ------------------------------------------------------------------------------------------------------------------
    ...
    well_plate = ctx.load_labware('greiner_96_wellplate_382ul', 2, '96 well plate')
